...
urlpatterns = [
    ...
    path('services/update-order/<int:service_id>/', views.update_service_order, name='update_service_order'),
    ...
    path('about/<int:about_id>/update-order/', views.update_about_order, name='update_about_order'),
    ...
    path('contacts/bulk-actions/', views.bulk_contact_actions, name='bulk_contact_actions'),
